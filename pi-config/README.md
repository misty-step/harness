...
for the OpenRouter account policy (US-028), and
[ADR-024](docs/adr/024-prototype-a-system-1-layer-on-raw-pi.md) for the System 1
/ System 2 prototype (US-029, US-030).
