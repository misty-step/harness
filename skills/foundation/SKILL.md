...
Read [operating foundations](operating-foundations.md) when verification,
deployment, hosting, or product operation could change the recommendation.
Select the relevant concerns; it is not an infrastructure checklist.
