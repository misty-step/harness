...
cwd/environment/stdio. This skill can be imported through a harness's supported
Agent Skills mechanism or read as ordinary Markdown; only the repository's OMP
adapter promises automatic discovery in OMP.
